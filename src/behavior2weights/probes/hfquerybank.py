...
from behavior2weights.utils import readjsonl,writejsonl
def buildhfquerybank(prompts_path:str|Path,output_path:str|Path,*,tokenizer_name:str,revision:str|None=None,sequence_length:int=128,text_field:str="text",local_files_only:bool=False,)->list[QueryRecord]:
    try:
    ...
    writejsonl(output_path,[record.model_dump(mode="json")for record in records])
    return records
