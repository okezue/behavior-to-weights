...
def nearest_behavior_neighbor(
    train_observations: Tensor,
    query_observation: Tensor,
    *,
    metric: str = "cosine",
) -> int:
...
def ridge_trace_to_weights(
    train_observations: Tensor,
    train_weights: Tensor,
    test_observations: Tensor,
    *,
    regularization: float = 1e-3,
) -> Tensor:
    """Closed-form linear trace-to-weight baseline for small experiments."""
